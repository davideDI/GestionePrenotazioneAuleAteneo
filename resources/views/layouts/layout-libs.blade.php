...
<link href="{{URL::asset('lib/css/style.css')}}" rel="stylesheet" />

<link href="{{URL::asset('lib/datetimepicker/css/bootstrap-datetimepicker.min.css')}}" rel="stylesheet" />
<script src="{{URL::asset('lib/datetimepicker/js/bootstrap-datetimepicker.min.js')}}" ></script>
