<?php
    ...
    return [
        ...
        'booking_screen_motor' => 'screen_motor',
        'booking_screen_manual' => 'screen_manual',
        'booking_audio' => 'Audio',
        'booking_pc' => 'PC',
        'booking_wire_mic' => 'wire_mic',
        'booking_wireless_mic' => 'wireless_mic',
        'booking_overhead_projector' => 'overhead_projector',
        'booking_visual_presenter' => 'visual_presenter',
